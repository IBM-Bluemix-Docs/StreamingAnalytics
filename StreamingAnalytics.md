...
* Customers wishing to synchronize their systems with the Streaming Analytics IBM Cloud service clocks should configure their network time protocol (NTP) settings to use the server: 
    ...
    For more information about setting up NTP, see the user documentation for your operating system.
