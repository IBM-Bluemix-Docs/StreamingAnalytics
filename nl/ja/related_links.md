...
* [{{site.data.keyword.streaminganalyticsshort}} SDK for Node.js™ スターター・アプリケーション](https://www.ibm.com/developerworks/library/ba-bluemix-detect-complex-events-from-data-stream-trs/index.html){:new_window}
...
* [{{site.data.keyword.Bluemix_notm}} {{site.data.keyword.streaminganalyticsshort}} 開発ガイド](https://developer.ibm.com/streamsdev/docs/bluemix-streaming-analytics-development-guide/){:new_window}
...
* [{{site.data.keyword.streamsshort}} for Apache Beam の資料
