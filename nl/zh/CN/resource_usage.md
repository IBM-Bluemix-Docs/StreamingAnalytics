...
## 查看和编辑实例资源
您可以在服务仪表板或 [V1 服务套餐](/docs/services/StreamingAnalytics/service_plans.html)的 V1 REST API 上查看和编辑实例的授权资源数。您必须使用 [V2 服务套餐](/docs/services/StreamingAnalytics/service_plans.html)的 [{{site.data.keyword.streaminganalyticsshort}} V2 REST API](https://console.bluemix.net/apidocs/streaming-analytics-v2-streaming-analytics-v2#get-a-streaming-analytics-instance)。
