  ...
  <tr>
    ...
    <td>
      <ul>
        ...
        <li>IAM 인증 및 사용자 신임 정보 인증을 모두 지원합니다.</li>
        <li>[{{site.data.keyword.streamsshort}} Quick Start Edition VM 이미지 ![외부 링크 아이콘](../../icons/launch-glyph.svg "외부 링크 아이콘")](http://ibmstreams.github.io/streamsx.documentation/docs/4.2/qse-install-vm/)를 지원합니다.
      </ul>    
    </td>
  </tr>
  <tr>
    ...
    <ul>
      ...
      <li>IAM 인증을 지원합니다.</li>
      <li>[{{site.data.keyword.streamsshort}} Quick Start Edition with Docker ![외부 링크 아이콘](../../icons/launch-glyph.svg "외부 링크 아이콘")](http://ibmstreams.github.io/streamsx.documentation/docs/4.2/qse-install-docker/)를 지원합니다.</li>
      <li>미국 남부 지역에서만 사용 가능합니다.</li>
    </ul>
    </td>
  </tr>
</table>
...
v1 REST API에 대한 자세한 정보는 [v1 REST API 문서 ![외부 링크 아이콘](../../icons/launch-glyph.svg "외부 링크 아이콘")](https://console.ng.bluemix.net/apidocs/220){:new_window}를 참조하십시오.
...
v2 REST API에 대한 자세한 정보는 [v2 REST API 문서 ![외부 링크 아이콘](../../icons/launch-glyph.svg "외부 링크 아이콘")](https://console.ng.bluemix.net/apidocs/1939){:new_window}를 참조하십시오.
