...
1. [{{site.data.keyword.streaminganalyticsshort}} 서비스의 신임 정보를 복사](/docs/services/StreamingAnalytics/service_plans.html#vcap_services)하고 작성한 VCAP 파일에 신임 정보를 붙여넣어 다음 행을 대체하십시오. 
```
