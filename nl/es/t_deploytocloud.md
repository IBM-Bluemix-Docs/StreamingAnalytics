...
1. Configure un entorno de desarrollo para desarrollar y probar la aplicación.
	...
	Si desea utilizar un entorno de {{site.data.keyword.streamsshort}}, puede descargar [{{site.data.keyword.streamsshort}} Quick Start Edition ![Icono de enlace externo](../../icons/launch-glyph.svg "Icono de enlace externo")](http://ibmstreams.github.io/streamsx.documentation/docs/4.2/qse-intro/){:new_window}, de forma gratuita.
